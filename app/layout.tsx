...
export const metadata: Metadata = {
  title: "Furnace Leads | B2B Lead Generation for Insurance & Sales",
  description:
    "High-quality exclusive inbound leads for insurance agencies, sales organizations, and service-based businesses. Book a consultation today.",
};
    ...
    <html lang="en">
      <body
        ...
        style={{
          ...
          fontFamily: 'var(--font-ibm-plex), "Inter", "Avenir Next", sans-serif',
          minHeight: "100vh",
        }}
      >
        <style>{`
